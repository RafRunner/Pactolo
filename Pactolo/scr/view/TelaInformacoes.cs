...
"\nAPA\n" +
$"Bernardy, J.L., Santana, R.N., & Passinato, E.B. (2019). Pactolo (Versão {version}). [Software]. São Paulo, SP: Universidade de São Paulo.\n" +
"\nABNT\n" +
$"BERNARDY, João Lucas; SANTANA, Rafael Nunes; PASSINATO, Emanuel Borges. Pactolo. Versão {version}. São Paulo.\n" +
$"\nVersão: {version}" +
