...
namespace Pactolo.scr.services {
    ...
    class ContingenciaColateralService : AbstractService {
        ...
        public static ContingenciaColateral GetById(long id) {
            ...
            var contingenciaColateral = GetById<ContingenciaColateral>(id, "ContingenciaColateral");
        ...
        public static List<ContingenciaColateral> GetAll() {
            var contingenciasColaterais = GetAll<ContingenciaColateral>("ContingenciaColateral");
        ...
        public static List<ContingenciaColateral> GetAllByCI(ContingenciaInstrucional CI) {
            ...
            using (IDbConnection cnn = new SQLiteConnection(GetConnectionString())) {
                return cnn.Query<ContingenciaColateral>("SELECT * FROM ContingenciaColateral WHERE CIId = @Id", CI).ToList();
            }
        }
        ...
        public static void Deletar(ContingenciaColateral CC) {
			...
			Deletar(CC, "ContingenciaColateral");
